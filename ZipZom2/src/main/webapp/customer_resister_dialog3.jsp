					...
					<li>
	              		...
	              		<span>옵션</span>
	              			<div class="input-group mb-3">
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">건조기</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck5" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">인덕션</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck6" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">전기렌지</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck7" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">가스렌지</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck8" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">옷장</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck9" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">싱크대</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck10" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">신발장</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck11" name="optionCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">냉장고</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="optioncheck12" name="optionCustomer" >
	              	...
	              	<li>
	              		<span>보안시설</span>
	              			<div class="input-group mb-3">
								<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck1" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">경비원</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck2" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">비디오폰</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck3" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">인터폰</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck4" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">카드키</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck5" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">CCTV</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck6" name="securityCustomer" >
	                        	...
	                        	<span style="margin-right: 10px; margin-top: 10px;">현관보안</span>
	                      		...
	                      		<div class="icheck-primary d-inline">
	                        	<input type="checkbox" id="securitycheck7" name="securityCustomer" >
