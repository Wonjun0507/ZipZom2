...
.w3-content::after {
  ...
  height: 100%;
  content: "";
  background: url("./resources/img/1234.jpg");
  position: absolute;
  top: 0;
  left: 0;
  z-index: -1;
...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
    ...
    <a href="./customer_manage.jsp" class="w3-bar-item w3-button">고객관리</a>
    ...
    <div id="demoAcc1" class="w3-bar-block w3-hide w3-padding-large w3-medium">
      <a href="./pfs_manage.jsp" class="w3-bar-item w3-button">등록매물관리</a>
      <a href="./pfs_compare.jsp" class="w3-bar-item w3-button">매물비교</a>
    </div>
    ...
    <div id="demoAcc2" class="w3-bar-block w3-hide w3-padding-large w3-medium">
      <a href="./rtp_search.jsp" class="w3-bar-item w3-button">매물 시세</a>
      <a href="" class="w3-bar-item w3-button">매물 위치</a>
    ...
    <a href="#" class="w3-bar-item w3-button">Property</a>
  </div>
