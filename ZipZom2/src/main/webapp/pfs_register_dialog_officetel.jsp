...
<div class="tab-pane fade show active" id="custom-tabs-four-officetel" role="tabpanel" aria-labelledby="custom-tabs-four-officetel-tab">
							<!-- 매물 주소 api 활용-->
							<div>
							...
							<div class="form-group row" >
								<li style="margin-right: 20px; margin-left: 7.5px; margin-top: 5px;">계약 유형 </li> 
	                      			...
	                      			<div class="icheck-primary d-inline">
	                        			<input type="radio" id="budget11" name="budget11" value="매매" checked>
	                        			<label for="budget11">
	                        			매매
	                        			</label>
	                      			</div>
	                      			...
	                      			<div class="icheck-primary d-inline">
	                        			<input type="radio" id="budget21" value="전세" name="budget11">
	                        			<label for="budget21">
	                        			전세
	                        			</label>
	                      			</div>
	                      			...
	                      			<div class="icheck-primary d-inline">
	                        			<input type="radio" id="budget31" value="월세" name="budget11" >
	                        			<label for="budget31">
	                        			월세
	                        			</label>
	                      			</div>
	              ...
	              <li>상세 정보 : 
					...
					<div class="input-group mb-4">
						...
						<select class="form-control" style="width: 200px; margin-right: 30px; margin-top: 5px;">
